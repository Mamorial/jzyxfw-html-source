            ...
            TableTools.BUTTONS = {
                ...
                "copy": $.extend({}, TableTools.buttonBase, {
                    ...
                    "fnComplete": function (nButton, oConfig, flash, text) {
                        ...
                        // @wangyi 2015-5-18 修改提示语言
                        this.fnInfo('<h6>表格已经复制</h6>' +
                ...
                "print": $.extend({}, TableTools.buttonBase, {
                    // @wangyi 2015-5-18 修改提示语言
                    "sInfo": "<h6>打印模式</h6><p>请使用浏览器的打印功能。 " +
                    "完成打印后使用ESC键返回</p>",
                    "sMessage": null,
                    "bShowAll": true,
...
// Alias to match the other plug-ins styling
             ...
             */
            TableTools.DEFAULTS = {
                //  @wangyi 2015-5-18 这里修改，发现应该用别的方式改啊，这次先这样吧。
                "sSwfPath": "resources/jquery.dataTables/extend/swf/copy_csv_xls_pdf.swf",
                "sRowSelect": "none",
                "sRowSelector": "tr",
                "sSelectedClass": null,
                "fnPreRowSelect": null,
